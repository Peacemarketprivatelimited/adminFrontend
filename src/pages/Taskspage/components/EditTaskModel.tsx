...
const EditTaskModal: React.FC<EditTaskModalProps> = ({ task, onClose, onSubmit }) => {
  const [formData, setFormData] = useState({
    ...
    maxPerUser: task.maxPerUser,
    expiryDate: task.expiryDate ? new Date(task.expiryDate).toISOString().slice(0, 16) : '',
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className=" rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Same form fields as CreateTaskModal */}
          <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-2 border border-gray-300 bg-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
          ...
          <div className="flex gap-3 pt-4 border-t">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-6 py-3 border border-gray-300 rounded-lg hover:bg-[#181C24] font-medium transition-colors"
            >
              Cancel
            </button>
            <button
